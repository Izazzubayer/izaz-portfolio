...
const designProjects = [
  ...
  },
  {
    ...
    description: "A comprehensive mobile application designed to revolutionize how users create, share, and discover short-form video content with enhanced social features.",
    link: "#",
    client: "Reel Inc.",
    role: "Lead Product Designer",
    team: ["Product Manager", "iOS Developer", "Android Developer", "Backend Engineer"],
    timeline: "8 months (Jan-Aug 2024)",
    tools: ["Figma", "Principle", "After Effects"],
    objective: "To create an intuitive and engaging short-form video platform that competes with existing social media apps",
    context: "With the growing popularity of short-form video content, there was an opportunity to create a platform with better creator tools and discovery mechanisms",
    painPoints: ["Complex video editing interface", "Poor content discovery", "Limited creator monetization options"],
    businessGoals: "Achieve 1M+ downloads within the first year and establish a strong creator community",
    researchMethods: ["Creator interviews", "Competitive analysis", "User behavior studies"],
    keyInsights: ["Creators needed simpler editing tools", "Discovery algorithm was crucial for engagement"],
    process: "Conducted extensive user research with content creators, designed intuitive editing workflows, and created an engaging discovery experience",
    testingResults: "User engagement increased by 40% during beta testing phase",
    impact: "Successfully launched with 500K+ downloads in first 3 months"
  },
  {
    id: 4,
